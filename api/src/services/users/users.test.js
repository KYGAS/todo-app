...
describe('users', () => {
  ...
  scenario('creates a user', async () => {
    ...
    expect(result.username).toEqual('String2756615')
    expect(result.email).toEqual('String8286206')
  ...
  scenario('updates a user', async (scenario) => {
    ...
    const result = await updateUser({
      id: original.id,
      input: { username: 'String37965182' },
    })

    expect(result.username).toEqual('String37965182')
  })
